...
export const ApiCollections = {
  ...
  /** orders apis */
  orders_list: { method: "POST", url: api_prefix + "orders-list" },
  orders_create: { method: "POST", url: api_prefix + "orders-create" },
  orders_get: { method: "GET", url: api_prefix + "orders-show/" },
  orders_update: { method: "POST", url: api_prefix + "orders-update/" },
